...
shinyServer(function(input, output) {
  ...
  library(plotrix)
  output$piechart <- renderPlot({ pie3D(slices(), labels = labels, col=rainbow(length(labels)),explode=0.00, main="positive & negative sentimental score for each tweets Analysis") })
